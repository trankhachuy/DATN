...
//			echo "</pre>";
			...
			if (isset($_POST['submit'])) {
				...
				//xử lý sua thong tin user trong trường hợp k có lỗi validate
            	...
            	if (empty($this->error)) {
	                //can kiem tra Th username da ton tai trong csdl thi bao loi
	                	...
	                	if($is_update){
	                		...
	                		$_SESSION['error'] = 'Thay đổi thông tin thất bại!';
	                	}
	                	header('Location: index.php?controller=login&action=inforUser');
	                	exit();
